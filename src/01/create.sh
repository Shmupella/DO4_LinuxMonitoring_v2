...
#исправить создание лог файлов как во 2 таске
#добавить проверку, что если путь это слэш, то название меняется, чтобы не было //fuck/emi.emi
#исправить некорректность проверки на доступную память
